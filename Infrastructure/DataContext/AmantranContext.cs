...
public partial class AmantranContext : DbContext
{
    ...
    public virtual DbSet<FieldSequence> FieldSequences { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-H1MSJ6U\\SQLEXPRESS; Database=Amantran; Trusted_Connection=True; TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FieldSequence>(entity =>
        {
            entity.HasKey(e => e.FieldSequenceId).HasName("PK__FieldSeq__0D12B556871A9CEB");

            entity.ToTable("FieldSequence");

            entity.Property(e => e.FieldSequenceId).HasColumnName("FieldSequence_id");
            ...
            entity.Property(e => e.Datatype)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.LookupFieldUi)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("Lookup_Field_UI");
            entity.Property(e => e.LookupFilterData)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("Lookup_Filter_Data");
            entity.Property(e => e.LookupFilterSource)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("Lookup_Filter_Source");
            entity.Property(e => e.SectionName)
                .HasMaxLength(50)
                .HasColumnName("Section_Name");
            entity.Property(e => e.SectionSequence)
                .HasMaxLength(10)
                .HasColumnName("Section_Sequence");
            entity.Property(e => e.Sequence).HasMaxLength(20);
        ...
        modelBuilder.Entity<WhatsappMessage>(entity =>
        {
            ...
            entity.Property(e => e.WhatsaapTemplateName)
                .HasMaxLength(250)
                .IsUnicode(false)
                .HasColumnName("whatsaap_template_name");
